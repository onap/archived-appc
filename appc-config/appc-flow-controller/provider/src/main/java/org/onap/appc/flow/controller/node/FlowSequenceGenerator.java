...
class FlowSequenceGenerator {
  ...
  String getFlowSequence(Map<String, String> inParams, SvcLogicContext ctx, SvcLogicContext localContext)
    ...
    String generationNode = localContext.getAttribute(GENERATION_NODE);
    ...
    String sequenceType = localContext.getAttribute(SEQUENCE_TYPE);
    ...
    return getFlowSequenceFromType(ctx, localContext, sequenceType);
  }
