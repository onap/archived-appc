...
public class TunableParametersTest {
    ...
    @Before
    public void setUp() {
        tunableParameters = new TunableParameters();
    }

    @Test
    public void testStrategy() {
        tunableParameters.setStrategy("strategy");
        assertEquals("strategy", tunableParameters.getStrategy());
    }

    @Test
    public void testWaitTime() {
        tunableParameters.setWaitTime("WaitTime");
        assertEquals("WaitTime", tunableParameters.getWaitTime());
    }
