...
public class ParamsHandlerConstant {
    ...
    public static final String INPUT_PARAM_PD_CONTENT = "pdContent";
    public static final String INPUT_PARAM_SYSTEM_NAME = "systemName";
    public static final String INPUT_PARAM_JSON_DATA = "jsonData";
    public static final String INPUT_PARAM_MERGE__JSON_DATA = "mergeJsonData";
    ...
    public static final String OUTPUT_PARAM_CONFIGURATION_PARAMETER = "configuration-parameters";
