...
public class WrapperEncryptionTool {
    ...
    public static void main(String[] args) 
    {
        ...
        try 
        {
            ...
            {    
                ...
                argList.add(vnf_type);
                argList.add(user);                
                DbServiceUtil.updateDB(Constants.DEVICE_AUTHENTICATION, argList, Constants.SCHEMA_SDNCTL, clause, setClause);    
    ...
    private static void updateProperties(String user, String vnf_type, String password, String action, String port, String url) {
