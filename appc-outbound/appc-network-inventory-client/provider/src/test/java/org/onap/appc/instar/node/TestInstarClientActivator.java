...
public class TestInstarClientActivator {
  ...
  public void setUp() {
    ...
    instarClientActivatorSpy = Mockito.spy(new InstarClientActivator());
  ...
  public void testStart() throws Exception {
    ...
    verify(instarClientActivatorSpy, times(1)).start(ctx);
  }
  ...
  public void testStop() throws Exception {
    ...
    verify(instarClientActivatorSpy, times(1)).stop(ctx);
  }
}
