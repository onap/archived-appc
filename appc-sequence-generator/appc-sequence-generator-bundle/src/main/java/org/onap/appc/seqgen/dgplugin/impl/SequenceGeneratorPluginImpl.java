...
public class SequenceGeneratorPluginImpl implements SequenceGeneratorPlugin {
    ...
    private CapabilityModel buildCapabilitiesModel(String inputJson) throws IOException, APPCException {
        ...
        List<String> vnfCapabilities = new ArrayList<String>();
        List<String> vfModuleCapabilities = new ArrayList<String>();
        Map<String, List<String>> vmCapabilities = new HashMap<>();
        List<String> vnfcCapabilities = new ArrayList<String>();
            ...
            for (JsonNode n : vmNode) {
                ...
                while (fldIter.hasNext()) {
                    ...
                    if (currentEntry.getValue().isArray()) {
                        ...
                        Iterator<JsonNode> is = currentEntry.getValue().elements();
                        List<String> ls = new ArrayList<String>();
                        while (is.hasNext()) {
                            logger.debug("is.hasNext() is true");
                            ls.add(is.next().asText());
                        }
