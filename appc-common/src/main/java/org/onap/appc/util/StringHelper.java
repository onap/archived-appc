...
public final class StringHelper {
     ...
     * then a regular expression that matches all strings (.*) is returned. <p> The expression passed to this method
     * should not already be a regular expression. If it contains problematic meta-characters for this routine (such as
     * period, asterisk, and plus), they will be escaped and matched literally in the resulting regular expression
     * returned. </p>
     *
     * @param value The pattern that we need to convert to a regular expression
     ...
     * shortened.
     *
     * @param maxLength must be at least 4 (one character plus ellipses)
     ...
     * @param a The first string to be compared
     * @param b The second string to be compared
     * @param caseInsensitive True if the comparison is to be case in-sensitive.
    ...
    /**
     * This method is used to mangle a name. <p> This method will first remove all unacceptable characters from the name
     * and translate all characters to lower case. This is done to eliminate any potentially troublesome characters. If
     * the resulting string is empty, then a random string of characters for the minimum desired length is returned. If
     * the string is too short to meet the minimum length requirement, it is padded with random characters. </p> <p>
     ...
     * name only from the left does not generate a unique name. </p>
     *
     * @param name The name to be mangled
     * @param minLen minimum number of characters for the name
     * @param maxLen maximum number of characters for the name
    ...
    /**
     * This method is used to normalize a string value. <p> This method will ensure that the string value is trimmed of
     * all leading and trailing whitespace if not null. If it is null or an empty string, then it will return null.
     * </p>
     *
     ...
     *
     * @param content The buffer to be processed
     ...
     *
     * @param sequence The input sequence to be processed
     * @param match The list of matching characters to be searched
     * @param replacement The list of replacement characters, positional coincident with the match list. If shorter than
     * the match list, then the position "wraps" around on the replacement list.
     ...
     *
     * @param name The name to be checked and converted to an identifier if needed
     ...
     * @param legal The set of all legal characters
     * @param replacement The replacement character if a character is not in the legal set
    ...
    /**
     * @param values An array or varargs of Strings to be concatenated into a comma-separated list
     ...
     *
     * @param props The properties object to format
