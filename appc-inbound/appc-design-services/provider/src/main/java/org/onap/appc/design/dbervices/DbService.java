...
public class DbService {
    ...
    public DbService() throws DBDesignException {
        ...
        try
        {
            ...
            if (dbLibSvc == null) {
                ...
                throw new DBDesignException("Got Exception While getting DB Connection");
            }
        }
        catch (Exception e) {
    ...
    public ResultSet getDBData(String query) throws SQLException {
        ResultSet resultSet;
    ...
    public ResultSet getDBData(String query, List<String> paramList) throws SQLException {
        ResultSet resultSet;
        StringBuilder sqlBuilder = new StringBuilder(query);
        Log.info("Query :" + sqlBuilder.toString());
        try {
    ...
    public boolean updateDBData(String query, List<String> paramList) throws SQLException {
        boolean update;
        StringBuilder sqlBuilder = new StringBuilder(query);
        Log.info("Query :" + sqlBuilder.toString());
        try {
