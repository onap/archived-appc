...
public class DBService {
    ...
    public Optional<String> getInternalVersionNumber(SvcLogicContext ctx, String artifactName, String prefix)
        ...
        return Optional.ofNullable(artifactInternalVersion);
    }
