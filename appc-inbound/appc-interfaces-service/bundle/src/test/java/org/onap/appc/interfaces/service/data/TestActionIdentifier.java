...
public class TestActionIdentifier {
    ...
    public void testServiceInstanceID() {
        actionIdentifier.setServiceInstanceID("ServiceInstanceID");
        assertEquals("ServiceInstanceID", actionIdentifier.getServiceInstanceID());
    }
