...
public class ProviderOperations {
     ...
     */
    @SuppressWarnings("nls")
    public boolean topologyDG(IncomingMessage msg) throws APPCException {
        if (msg == null) {
        ...
        try {
            ...
            String body = buildReqest(msg.getHeader().getRequestID(), msg.getPayload().getAicvServerSelfLink(), msg.getPayload().getAicIdentity());
    ...
    private String buildReqest(String id, String url, String ident) {
