...
public class RequestHandlerImpl implements RequestHandler {
    ...
    private void storeAuditLogRecord(RuntimeContext runtimeContext) {
        LoggingUtils.logAuditMessage(runtimeContext.getTimeStart() != null ? Date.from(runtimeContext.getTimeStart()) : null,
    ...
    private void storeMetricLogRecord(RuntimeContext runtimeContext) {
        LoggingUtils.logMetricsMessage(runtimeContext.getTimeStart() != null ? Date.from(runtimeContext.getTimeStart()) : null,
                new Date(System.currentTimeMillis()),
                LoggingConstants.TargetNames.APPC,
