...
public class LicenseManagerImplTest {
    ...
    public void retrieveLicenseModel_shouldReturnCorrectLicenseModel_whenCorrectXmlExists() {
        ...
        // GIVEN
        final String expectedEntitlementPool = "default_entitlement_pool";
        final String expectedKeyGroup = "default_key_group";

        final String correctlyFormedXml = String.format("<entitlement-pool-uuid>%s</entitlement-pool-uuid>"
            + "<license-key-group-uuid>%s</license-key-group-uuid>", expectedEntitlementPool, expectedKeyGroup);
