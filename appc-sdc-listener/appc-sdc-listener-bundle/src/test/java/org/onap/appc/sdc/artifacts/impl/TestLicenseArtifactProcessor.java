...
public class TestLicenseArtifactProcessor {
    ...
    public void setup() throws Exception{
        ...
        artifactProcessor = Mockito.spy(new LicenseArtifactProcessor(client,eventSender,ArtifactProcessorUtility.getNotificationData(),ArtifactProcessorUtility.getResources().get(0)
	...
	public void testProcessArtifactNullSDCArtifact() throws APPCException {
		...
		artifact.setArtifactUUID("123-456-789");
		artifact.setResourceName("Resource Name");
		when(storageService.retrieveSDCArtifact(anyString(), anyString(), anyString())).thenThrow(new APPCException());
		artifactProcessor.processArtifact(artifact);
	}
}
