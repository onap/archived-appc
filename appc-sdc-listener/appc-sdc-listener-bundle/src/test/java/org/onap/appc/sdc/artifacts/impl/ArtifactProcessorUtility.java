...
public class ArtifactProcessorUtility {
  ...
  public static INotificationData getNotificationData() throws APPCException {
  ...
  public static List<IResourceInstance> getResources() throws APPCException {
  ...
  private static Object getObject(String fqcn) throws APPCException {
    Object object = null;
    try {
      Constructor constructor = Arrays.asList(Class.forName(fqcn).getDeclaredConstructors())
          .stream().filter(constructor1 -> constructor1.getParameterCount() == 0)
  ...
  public static List<IArtifactInfo> getServiceArtifacts() throws APPCException {
    List<IArtifactInfo> serviceArtifacts = null;
    try {
      serviceArtifacts = new ArrayList<>();
