...
public class ArtifactProcessorUtility {
  ...
  public static INotificationData getNotificationData() throws ClassNotFoundException,
  ...
  public static List<IResourceInstance> getResources() throws ClassNotFoundException,
  ...
  private static Object getObject(String fqcn) throws ClassNotFoundException,
      InstantiationException, IllegalAccessException, InvocationTargetException {
    Constructor constructor = Arrays.asList(Class.forName(fqcn).getDeclaredConstructors()).stream()
        .filter(constructor1 -> constructor1.getParameterCount() == 0).collect(Collectors.toList())
        .get(0);
    constructor.setAccessible(true);
    return constructor.newInstance();
  }

  public static List<IArtifactInfo> getServiceArtifacts() throws ClassNotFoundException,
      InvocationTargetException, InstantiationException, IllegalAccessException {
