...
public class TestConfigArtifcatProcessor {
  ...
  public void setup() throws APPCException {
    ...
    configArtifactProcessor = new ConfigArtifactProcessor(client, eventSender,
        ArtifactProcessorUtility.getNotificationData(),
        ArtifactProcessorUtility.getResources().get(0),
        ArtifactProcessorUtility.getServiceArtifacts().get(0), uri);
   ...
   */
  @Test
  public void testProcessArtifactWithNoURI() throws Exception {
    configArtifactProcessor = new ConfigArtifactProcessor(client, eventSender,
        ArtifactProcessorUtility.getNotificationData(),
        ArtifactProcessorUtility.getResources().get(0),
        ArtifactProcessorUtility.getServiceArtifacts().get(0), null);
    ConfigArtifactProcessor configArtifactProcessorSpy = Mockito.spy(configArtifactProcessor);
    configArtifactProcessorSpy.processArtifact(sdcArtifact);
    verify(configArtifactProcessorSpy, times(1)).processArtifact(sdcArtifact);
  }
