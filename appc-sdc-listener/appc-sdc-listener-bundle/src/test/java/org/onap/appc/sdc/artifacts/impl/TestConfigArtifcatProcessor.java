...
public class TestConfigArtifcatProcessor {
	...
	public void setup() throws Exception {
		...
		configArtifactProcessor = new ConfigArtifactProcessor(client, eventSender, ArtifactProcessorUtility.getNotificationData(),
				ArtifactProcessorUtility.getResources().get(0), ArtifactProcessorUtility.getServiceArtifacts().get(0), uri);
