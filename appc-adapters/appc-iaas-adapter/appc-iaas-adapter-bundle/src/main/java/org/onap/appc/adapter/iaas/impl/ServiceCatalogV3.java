...
public class ServiceCatalogV3 extends ServiceCatalog {
    ...
    private boolean validate(VMURL url, Matcher matcher) {
    ...
    private void resolveEndpoints(Service service, String type) {
