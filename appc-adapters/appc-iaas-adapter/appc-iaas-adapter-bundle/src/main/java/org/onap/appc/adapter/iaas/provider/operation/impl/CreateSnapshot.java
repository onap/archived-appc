...
public class CreateSnapshot extends ProviderServerOperation {
    ...
    private Image createSnapshotNested(Image SnapShot, RequestContext RcContext, VMURL vm, String vm_url, String identStr) 
        ...
        try {
            context = getContext(RcContext, vm_url, identStr);
            if (context != null) {
