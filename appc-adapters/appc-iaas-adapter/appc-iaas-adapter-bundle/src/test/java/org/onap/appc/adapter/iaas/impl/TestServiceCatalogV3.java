...
public class TestServiceCatalogV3 {
    ...
    public void setup(){
		...
		serviceEndpoints = ImmutableMap.<String, List<Service.Endpoint>>builder().put(ServiceCatalog.COMPUTE_SERVICE,endpoints).build();
        Map<String, Object> privateFields = ImmutableMap.<String, Object>builder().put("project",project).put("regions", regions)
	...
	private void injectMockObjects(Map<String, Object> privateFields) {
		final Object catalogObject = (Object) catalog;
