...
public class TestEnvironment {
    ...
    public void testGetParameters() {
        ...
        assertEquals(environment.getParameters(), parameters);
    }
    ...
    public void testGetResourceRegistry() {
        ...
        assertEquals(environment.getResourceRegistry(), resourceRegistry);
    }

    @Test
    public void testToString() {
        environment.setResourceRegistry(resourceRegistry);
        assertEquals(environment.toString(), environment.toString());
    }
}
