...
public class DmaapOutgoingMessageTest {
    ...
    public void testGetServiceInstanceId() {
        ...
        Assert.assertNotNull(dmaapOutgoingMessage.getType());
    ...
    public void testGetCorrelationId() {
        ...
        Assert.assertNotNull(dmaapOutgoingMessage.getCorrelationID());
    ...
    public void testGetCambriaPartition() {
        ...
        Assert.assertNotNull(dmaapOutgoingMessage.getCambriaPartition());
    ...
    public void testGetRpcName() {
        ...
        Assert.assertNotNull(dmaapOutgoingMessage.getRpcName());
    ...
    public void testGetBody() {
        ...
        Assert.assertNotNull(dmaapOutgoingMessage.getBody());
