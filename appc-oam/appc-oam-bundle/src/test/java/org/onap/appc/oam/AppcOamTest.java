...
public class AppcOamTest {
    ...
    public void testGetAppcState() throws Exception {
        ...
        GetAppcStateInput mockGetAppcStateInput = mock(GetAppcStateInput.class);
        Future<RpcResult<GetAppcStateOutput>> state = appcOam.getAppcState(mockGetAppcStateInput);
    ...
    public void testGetMetricsMetricDisabled() throws InterruptedException, ExecutionException {
        ...
        GetMetricsInput mockGetMetricsInput = mock(GetMetricsInput.class);
        Future<RpcResult<GetMetricsOutput>> result = appcOam.getMetrics(mockGetMetricsInput);
