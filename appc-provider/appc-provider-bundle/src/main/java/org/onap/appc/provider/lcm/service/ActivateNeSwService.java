...
/**
 * Provide LCM command service for Activating Ne Sw
 */
public class ActivateNeSwService extends AbstractBaseService {
	/**
     * Constructor
     */
    public ActivateNeSwService() {
        super(Action.ActivateNeSw);
        logger.debug("ActivateNeSwService starts");
    }
    ...
    void validate(CommonHeader commonHeader, Action action, ActionIdentifiers actionIdentifiers, Payload payload) {
        ...
        try {
            ...
            logger.error(String.format("ActivateNeSwService (%s) got IOException when converting payload", rpcName), e);
