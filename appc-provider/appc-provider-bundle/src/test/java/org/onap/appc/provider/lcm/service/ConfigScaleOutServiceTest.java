...
@PrepareForTest({ConfigScaleOutService.class, RequestExecutor.class})
public class ConfigScaleOutServiceTest {
    ...
    public void testConstructor() throws Exception {
        Action expectedAction = Action.ConfigScaleOut;
        Assert.assertEquals("Should have proper ACTION", expectedAction,
                (Action) org.powermock.reflect.Whitebox.getInternalState(configscaleoutServiceAction, "expectedAction"));
        Assert.assertEquals("Should have config-scale-out RPC name", "config-scale-out",
                (org.powermock.reflect.Whitebox.getInternalState(configscaleoutServiceAction, "rpcName")).toString());
    }
