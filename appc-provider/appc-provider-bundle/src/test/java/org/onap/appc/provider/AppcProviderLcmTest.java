...
public class AppcProviderLcmTest {
    ...
    public void setupMocksForTests() {
        ...
        Mockito.doReturn(rpcRegistration).when(rpcProviderRegistry).addRpcImplementation(eq(AppcProviderLcm.class), Mockito.any(AppcProviderLcm.class));
        underTest = new AppcProviderLcm(dataBroker, notificationProviderService, rpcProviderRegistry);
    }
    ...
    public void configScaleOutTest() {
        ...
        Mockito.doReturn(getCommonHeaderBuilder().build()).when(configScaleOutInput).getCommonHeader();
